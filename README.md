...
A Go REST API that allows users to deposit digital assets (ETH, USDT, BNB, BTC, etc.) as collateral and receive fiat loans calculated from a Loan-To-Value (LTV) ratio. Repayments are scheduled; late repayments incur penalties. After full repayment, users can request release of their collateral.
